...
class Level:
    def __init__(self, screen, bg_prefix, bg_count, bg_start_index, level_actual_width):
        ...
        # Grupos de Sprites
        self.player = Player((const.PLAYER_START_X, const.PLAYER_START_Y))
        self.enemies = pygame.sprite.Group()
        self.enemy_shots = pygame.sprite.Group() # Grupo para organizar os tiros dos inimigos
    ...
    def _spawn_enemy(self):
        ...
        # Usa a nova constante para a altura dos inimigos.
    ...
    def run(self, clock):
        while True:
            ...
            if delta_time > 0:
                ...
                # Coleta os tiros dos inimigos no grupo principal de tiros de inimigos
                ...
                EntityMediator.check_all_collisions(
                    self.player, self.enemies, self.player.shots_group, self.enemy_shots
                )
